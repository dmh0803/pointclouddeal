	...
	, m_sfMax(0)
{
	...
	samplingMethod->addItem("随机");
	samplingMethod->addItem("空间");
	samplingMethod->addItem("八叉树");
...
void ccSubsamplingDlg::updateLabels()
{
	...
	{
	case RANDOM:
		labelSliderMin->setText("无");
		labelSliderMax->setText("全部");
		valueLabel->setText("剩余点");
		break;
	case SPACE:
		labelSliderMin->setText("大");
		labelSliderMax->setText("小");
		valueLabel->setText("最小点间距");
		break;
	case OCTREE:
		labelSliderMin->setText("最小");
		labelSliderMax->setText("最大");
		valueLabel->setText("细分层次");
		break;
	default:
		break;
	}
